...
🧭 Back/Front [Type-safe API route declarations](/guides/api-services/), shared models   
🔒 Unified [model definitions and security configuration](/guides/models-and-daos/)  
🔌 Powerful [plugin system](/plugins/1_plugins/) (Managed Login, ApiKey Login...) (BETA)  
